...
public class CustomerResources {
	...
	public @ResponseBody Fare loadCustomerFare(@PathVariable(value="customer-code") String customerCode, @RequestParam(value="pooling-subscriber",required=false,defaultValue="true") Boolean poolingSusbcriber , HttpServletRequest request){
		Long clockOn = System.currentTimeMillis();
		Fare result = this.service.loadCustomerFare(customerCode, poolingSusbcriber);
	...
	@ResponseStatus(value = HttpStatus.OK)
	public @ResponseBody Fare registerDevice( @PathVariable(value="customer-code") String customerCode, 
